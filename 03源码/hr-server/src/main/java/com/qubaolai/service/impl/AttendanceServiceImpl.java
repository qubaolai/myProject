...
public class AttendanceServiceImpl implements AttendanceService {
    ...
    public ResultVo updateSingInLog(Map<String, Object> map) {
        ...
        //获取上班签到时间
        if (null != map.get("startDate") && !"".equals(map.get("startDate"))) {
...
//            attendanceCriteria.andEmployeeNumberIn(empIds);
        ...
        //签到日期
        if (!"".equals(param.get("singDate")) && param.get("singDate") != null) {
            List<String> singDate = (List<String>) param.get("singDate");
            String singDateStart = singDate.get(0).toString();
            String singDateEnd = singDate.get(1).toString();
